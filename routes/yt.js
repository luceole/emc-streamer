...
/*
 * Download on Server as local video
 */
...
exports.getoembed = function (req, res) {
  ...
  var url =
    ...
    req.params.idVideo + "&format=json";
  axios
    .get(url)
    .then(result => {
      // console.log(`statusCode: ${result.status}`)
      // console.log(result.data)
      //res.send(req.query.callback  + result.data.html.html );
      //  res.send(req.query.callback + "(" + JSON.stringify(result.data) + ");");
      request(url, (error, reponse) => {
...
exports.getembed = function (req, res) {
  ...
  var url =
    "https://www.youtube.co/oembed?url=http%3A//www.youtube.com/watch%3Fv%3D" +
    req.params.idVideo +
    "&format=json";
  axios
    .get(url)
